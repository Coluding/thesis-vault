...
\citet{\nv{rigter2024avid}} follows actions on the same environment, with
...
it~\citep{\nv{chen2024gentron}}; the same has been reported for
...
inert~\citep{\nv{motifvideo2026}}. The claim is therefore conditional: in a
...
diffusion~\citep{\nv{peebles2023dit}} and, more recently, for action
conditioning specifically~\citep{\nv{ioi2026}, \nv{nanowm2026}}; that the
gap widens under a frozen backbone has also been
reported~\citep{\nv{dae2026}}, attributed there to conditioning being routed
