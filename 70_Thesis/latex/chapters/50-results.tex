...
\section{What the adapter learns instead (D2)}
\label{sec:res-decomposition}
\todo{Shared-target convergence vs oracle-reading vs the 0.45% economics.
The global-bag structure result. The economics also PREDICTED the late
escape on DC before it was observed -- say so; a prediction that lands is
worth more than a post-hoc explanation.}
...
and has no access to the counterfactual --- what this model would have
