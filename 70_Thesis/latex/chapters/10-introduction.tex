...
--- unlike consistency and shortcut models, which retrain the prior. We show
...
\paragraph{What we do not claim.} We do not demonstrate rollout-level
control: that a swapped action sequence sends the trajectory where it should
go is not established on any cell. We do not claim competitive few-step
