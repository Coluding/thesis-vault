...
resolution: shipped
resolution_note: >
  All 3 patches landed (Heun regularizer added, live configs migrated to
  distillation, two_step code deleted) — see the ticket's own "Progress"
  section. Closing on the code being complete; the remaining doc-polish items
  (surface heun_smoothness_weight in an example config, update 3 vault notes,
  optional heavy-config ≥100-step validation run) spun into
  [[chore-writing-heun-twostep-doc-polish]] so they don't get lost.
...
related:
  ...
  - "[[chore-writing-heun-twostep-doc-polish]]"
---
